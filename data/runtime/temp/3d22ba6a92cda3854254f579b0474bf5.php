<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./template/pc/lists_search.htm";i:1589434577;s:43:"D:\phpStudy\WWW\hxsw\template\pc\header.htm";i:1589957599;s:43:"D:\phpStudy\WWW\hxsw\template\pc\footer.htm";i:1589958179;}*/ ?>
<!DOCTYPE html>
<html>
 <head> 
        ...
        <ul class="ulstyle ey-pager-ajax imagesize"> 
         ...
         <li class="media media-lg border-bottom1"> 
          <div class="media-left"> 
           <a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>"> <img class="media-object" src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>" /></a> 
          </div> 
          <div class="media-body"> 
           ...
           <p class="info font-weight-300"> <span><?php echo MyDate('Y-m-d',$field['add_time']); ?></span> <span></span> <span> <i class="icon fa-eye m-r-5 font-weight-300"></i> <?php echo $field['click']; ?> </span> </p> 
          </div>
         </li> 
         <?php ++$e; $aid = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
        </ul> 
