<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"./application/admin/template/system\customvar_add.htm";i:1589434587;s:65:"D:\phpStudy\WWW\hxsw\application\admin\template\public\layout.htm";i:1589434587;s:65:"D:\phpStudy\WWW\hxsw\application\admin\template\public\footer.htm";i:1589434587;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('System/customvar_add'); ?>" method="post">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <label><input type="radio" value="0" name="attr_input_type" checked="checked" />单行文本</label>
                    <br/>
                    <label><input type="radio" value="2" name="attr_input_type" />多行文本</label>
                    <br/>
                    <label><input type="radio" value="3" name="attr_input_type" />上传图片</label>
                    <span class="err" id="err_attr_input_type" style="color:#F00; display:none;"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row attr_input_typeall">
                <dt class="tit">
                    <label for="attr_values">变量值</label>
                </dt>
                <dd class="opt">
                    <textarea rows="10" cols="30" name="attr_values" id="attr_values" class="input-txt" style="height:36px;"></textarea>
                    <span id="err_attr_values" class="err" style="color:#F00; display:none;"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row attr_input_type3 none">
                <dt class="tit">
                  <label>上传图片</label>
                </dt>
                <dd class="opt">
                    <div class="input-file-show div_value_local">
                        <span class="show">
                        ...
                        <span class="type-file-box">
                            <input type="text" id="value_local" name="value_local" value="" class="type-file-text">
                            <input type="button" name="button" id="button1" value="选择上传..." class="type-file-button">
                            <input class="type-file-file" onClick="GetUploadifyFrame(1,'','allimg','img_call_back','<?php echo url('Uploadify/upload_frame'); ?>')" size="30" hidefocus="true" nc_type="change_site_logo"
                                 title="点击前方预览图可查看大图，点击按钮选择文件并提交表单后上传生效">
                        </span>
                    </div>
                    <input type="text" id="value_remote" name="value_remote" value="" placeholder="http://" class="input-txt" style="display: none;">
                    &nbsp;
                    <label><input type="checkbox" name="is_remote" id="is_remote" value="1" onClick="clickRemote(this, 'value');">远程图片</label>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
...
<script type="text/javascript">
    ...
    function check_submit(){
        ...
        $.ajax({
            url: "<?php echo url('System/customvar_add'); ?>",
            type: 'POST',
            dataType: 'JSON',
