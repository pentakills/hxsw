<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"./application/admin/template/uploadify\picture_folder.htm";i:1589434587;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<body>
    ...
    <div class="ui-layout-center" >
        <ul class="tabs">
            <a href="<?php echo url('Uploadify/upload',['num'=>$info['num'],'input'=>$info['input'],'path'=>$info['path'],'func'=>$info['func'],'lang'=>\think\Request::instance()->param('lang')]); ?>"><li>本地上传</li></a>
            <li class="checked">在线管理</li>
    ...
    <script type="text/javascript">
        ...
        $("#saveBtn").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo url('Uploadify/update_pic'); ?>",
