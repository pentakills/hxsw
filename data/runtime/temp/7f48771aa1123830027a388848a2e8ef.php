<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"./application/admin/template/uploadify\get_images_path.htm";i:1589434587;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<body>
    ...
    <div class="ui-layout-center" id="online">
        <ul id="list" class="tabs">
            ...
            <?php else: if(!(empty($common_pic) || (($common_pic instanceof \think\Collection || $common_pic instanceof \think\Paginator ) && $common_pic->isEmpty()))): ?>
                    <div class="heading">
                      <h2>智能推荐</h2>
                      <hr>
                    </div>
