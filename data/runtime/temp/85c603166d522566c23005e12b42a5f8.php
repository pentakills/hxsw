<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"./application/admin/template/public\dispatch_jump.htm";i:1589434587;}*/ ?>
...
<?php switch($code): case "1": 
        ...
        <div class="system-message">
            ...
            <ul>
                <li><span><?php echo $msg1; ?>文档</span><a href="<?php echo \think\Request::instance()->baseFile(); ?>?m=admin&c=Archives&a=add&typeid=<?php echo $data['tid']; ?>&lang=<?php echo (\think\Request::instance()->param('lang') ?: 'cn'); ?>" style="display: none;"><?php echo $msg1; ?>文档</a></li>
        ...
        if(aid > 0){
            $.ajax({
                ...
                type:'POST',
                dataType:'json',
                data:{aid:aid,typeid:typeid,type:'view',_ajax:1},
                success:function(res){
                    ...
                    $.ajax({
                        ...
                        type:'POST',
                        dataType:'json',
                        data:{aid:aid,typeid:typeid,type:'lists',_ajax:1},
                        success:function(res){
                            layer.closeAll();
                            $('#tips').html('');
                        },
