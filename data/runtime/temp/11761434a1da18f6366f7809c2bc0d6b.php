<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/template/admin\login.htm";i:1589434587;s:65:"D:\phpStudy\WWW\hxsw\application\admin\template\public\footer.htm";i:1589434587;}*/ ?>
<!DOCTYPE html>
            ...
            $(function(){
                ...
                $('#theForm input[name=submit]').on('click',function(){
                    ...
                    if(vertify && $('#theForm input[name=user_name]').val() != '' && $('#theForm input[name=password]').val() != ''){
                        var url = "<?php echo url('Admin/login'); ?>";
                        if (url.indexOf('?') > -1) {
                            url += '&';
                        } else {
                            url += '?';
