<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:33:"./template/pc/lists_guestbook.htm";i:1589961352;s:43:"D:\phpStudy\WWW\hxsw\template\pc\header.htm";i:1589957599;s:43:"D:\phpStudy\WWW\hxsw\template\pc\footer.htm";i:1589958179;}*/ ?>
<!DOCTYPE html>
<html>
 <head> 
        ...
        <?php  $typeid = ""; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagGuestbookform = new \think\template\taglib\eyou\TagGuestbookform; $_result = $tagGuestbookform->getGuestbookform($typeid, "default"); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $mod = ($e % 2 );$i= intval($key) + 1;?>
          <form method="POST" class="guest-form" enctype="multipart/form-data" action="<?php echo $field['action']; ?>" onsubmit="return checkForm();">
              <div class="form-group">
                <input class="guest-input form-control" id="attr_18" type="text" value="" name="<?php echo $field['attr_18']; ?>" placeholder="<?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:8:"xingming";}'); echo $__VALUE__; ?>">
              </div>
              <div class="form-group">
                <input class="guest-input form-control" id="attr_20" type="text" value="" name="<?php echo $field['attr_20']; ?>" placeholder="<?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:6:"shouji";}'); echo $__VALUE__; ?>">
              </div>
              <div class="form-group">
                <input class="guest-input form-control" id="attr_22" type="text" value="" name="<?php echo $field['attr_22']; ?>" placeholder="<?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:8:"youxiang";}'); echo $__VALUE__; ?>">
              </div>
              <div class="form-group">
                <textarea class="guest-textarea form-control" id="attr_24" cols="40" rows="3" name="<?php echo $field['attr_24']; ?>" placeholder="<?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:7:"neirong";}'); echo $__VALUE__; ?>"></textarea>
              </div>
              <!-- <div class="form-group">
              ...
              <div class="div-guest-submit"><input type="submit" class="btn btn-primary btn-block btn-squared" value="<?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:6:"tijiao";}'); echo $__VALUE__; ?>"></div>
          ...
          <script type="text/javascript">
            function checkForm()
            {
              ...
              {
                alert('<?php echo $field['itemname_18']; ?>不能为空！');
                return false;
              }
              if(document.getElementById('attr_20').value.length == 0)
              {
                alert('<?php echo $field['itemname_20']; ?>不能为空！');
                return false;
              }
