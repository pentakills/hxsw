<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/template/index\welcome.htm";i:1589434587;s:65:"D:\phpStudy\WWW\hxsw\application\admin\template\public\footer.htm";i:1589434587;}*/ ?>
<!doctype html>
<html>
<head>
...
<div id="footer" style="position: static; bottom: 0px; font-size:14px;">
    <p>
        <b><?php echo htmlspecialchars_decode($global['web_copyright']); ?>--SEO技术支持：<a href="http://www.0917bjms.com/">麦思科技</a></b>
    </p>
</div>
<script type="text/javascript">
    $(function () {
        ...
        function check_language_tips()
        {
            if (__main_lang__ != __lang__) {
                ...
                layer.msg('已切换多语言【'+language_title+'】后台编辑！', {time:3000});
            }
        }
    ...
    $(function() {
        ...
        $("#checkZoom").click(function(){
            ...
            $.get("<?php echo url('Ajax/explanation_welcome', ['_ajax'=>1]); ?>");
        });
