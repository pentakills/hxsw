<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./application/admin/template/arctype\index.htm";i:1589434587;s:65:"D:\phpStudy\WWW\hxsw\application\admin\template\public\layout.htm";i:1589434587;s:65:"D:\phpStudy\WWW\hxsw\application\admin\template\public\footer.htm";i:1589434587;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    if(typeid > 0){
      $.ajax({
        url:__root_dir__+"/index.php?m=home&c=Buildhtml&a=upHtml",
          type:'get',
          dataType:'json',
          data:{'typeid':typeid,'is_del':is_del,_ajax:1},
          success:function(data){
              console.log("生成静态成功");
          }
      });
