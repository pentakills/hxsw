<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin/template/index\index.htm";i:1589437978;s:66:"D:\phpStudy\WWW\hxsw\application\admin\template\public\menubox.htm";i:1589434587;s:63:"D:\phpStudy\WWW\hxsw\application\admin\template\public\left.htm";i:1589434587;}*/ ?>
<!doctype html>
<html>
<head>
...
<title><?php echo (isset($global['web_name']) && ($global['web_name'] !== '')?$global['web_name']:''); ?></title>
              ...
              <em class="eyou_tool em_authortoken" data-expanded="close">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="shouquan">
                    ...
                    <li class="ey-tool-list text-center">
                      <input class="btn btn-primary" type="button" onclick="$('.em_authortoken').toggleClass('open');openItem('Index|authortoken');" value="点击校验授权" />
                    </li>
                </ul>
               </em>
              <!-- 商业授权 -->   
...
<script type="text/javascript">
  ...
  {
      layer_loading("正在处理");
      var url = "<?php echo url('Index/edit_adminlogo', ['_ajax'=>1]); ?>";
