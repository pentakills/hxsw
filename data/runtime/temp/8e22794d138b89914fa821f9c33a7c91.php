<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/product\add.htm";i:1589434587;s:65:"D:\phpStudy\WWW\hxsw\application\admin\template\public\layout.htm";i:1589434587;s:70:"D:\phpStudy\WWW\hxsw\application\admin\template\field\addonextitem.htm";i:1589434587;s:65:"D:\phpStudy\WWW\hxsw\application\admin\template\public\footer.htm";i:1589434587;}*/ ?>
<!doctype html>
<html>
<head>
...
<script type="text/javascript" src="/public/plugins/Ueditor/ueditor.config.js?v=v1.3.7"></script>
<script type="text/javascript" src="/public/plugins/Ueditor/ueditor.all.min.js?v=v1.3.7"></script>
<script type="text/javascript" src="/public/plugins/Ueditor/lang/zh-cn/zh-cn.js?v=v1.3.7"></script>
...
<div class="page" style="min-width:auto;">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Product/add'); ?>" method="post">
        ...
        <?php if(!empty($shopConfig['shop_open']) && 1 == $shopConfig['shop_open']): ?>
            <!-- 产品价格属性 -->
            <?php if(empty($shopConfig['shop_type']) || (($shopConfig['shop_type'] instanceof \think\Collection || $shopConfig['shop_type'] instanceof \think\Paginator ) && $shopConfig['shop_type']->isEmpty())): ?>
                <input type="hidden" name="prom_type" value="0"/>
            <?php endif; if($shopConfig['shop_type'] == '1'): ?>
            ...
            <?php endif; if($shopConfig['shop_type'] == '2'): ?>
                <dl class="row">
                    ...
                    <dd class="opt">
                        <label>
                            <input type="radio" name="prom_type" value="0" checked="checked"/>普通产品
                        </label>
                        <br/>
                        <label>
                            <input type="radio" name="prom_type" value="1" />虚拟产品
                        </label>
                    </dd>
                </dl>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="users_price" value="" id="users_price" class="input-txt" maxlength="100">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
